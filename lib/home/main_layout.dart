                        ...
                        children: [
                          ...
                          Text(
                            "Lorem ipsum dolor sit amet, consectetur " +
                                "adipiscing elit. Donec ultrices eget arcu in porta."
                                    " Aliquam sit amet dolor tempor, faucibus erat sit amet, "
                                    "mollis enim. Quisque lorem est, ornare at tincidunt eget, "
                                    "auctor at purus. Aliquam mollis efficitur sapien, ac "
                                    "rutrum mauris venenatis eu. Integer at sem vehicula, "
                                    "fermentum lorem at, interdum ex. Phasellus viverra imperdiet mattis. "
                                    "Donec consectetur eget massa sit amet rutrum. "
                                    "Praesent convallis nunc in orci auctor, vel gravida nisi pharetra. "
                                    "Donec vitae neque et enim commodo facilisis a at nibh.",
                            maxLines: 3,
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        randomDate.random().day.toString() + " - "
                                            + randomDate.random().month.toString() + " - "
                                            + randomDate.random().year.toString(),
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            fontSize: 10,
                                            fontWeight: FontWeight.w500,
